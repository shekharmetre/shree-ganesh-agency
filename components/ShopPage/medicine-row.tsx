...
export function MedicineRow({ medicine }: MedicineRowProps) {
  ...
  const updateQuantity = (delta: number) => {
    ...
    const {cart:mediCart,totalPrice:mediTotal} = useAppSelector((state:RootState)=>state.carts)
  
    console.log(mediCart)
    console.log(mediTotal);
            ...
            <div className="p-4 bg-gray-50 space-y-2">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Bulk Discount:</span> {medicine.bulkDiscount}
                  </p>
                </div>
                <div>
                  <p className="text-sm">
