...
export const HeroShop = () => {
  return (
    <div className="bg-gradient-to-b from-[#0A2533] to-[#1E3A4D]
  text-white">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
          ...
          <div className="space-y-6 lg:space-y-8 mb-12 lg:mb-0">
            <div className="space-y-3">
              ...
              <motion.h1
                className="text-3xl lg:text-6xl font-bold text-amber-400 leading-tight mb-2"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <motion.p
                className="text-md lg:text-3xl text-gray-300 leading-snug"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
